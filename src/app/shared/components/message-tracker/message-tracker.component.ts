...
export class MessageTrackerComponent {
    ...
    constructor(@Inject(MAT_SNACK_BAR_DATA) public data: ErrorDataInterface, public snackBarRef: MatSnackBarRef<MessageTrackerComponent>, private _messageTrackerService: MessageTrackerService) {
