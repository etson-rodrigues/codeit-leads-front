...
import { ProcessosModule } from '../processos-judiciais/consulta-geral/processos.module';
    ...
    beforeEach(
        waitForAsync(() => {
            ...
            TestBed.configureTestingModule({
                ...
                imports: [LoginModule, ProcessosModule, RouterTestingModule.withRoutes(routes), NoopAnimationsModule],
                providers: [
