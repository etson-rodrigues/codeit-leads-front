...
export class SeletorTemasComponent implements OnInit {
    ...
    constructor(private _formBuilder: FormBuilder, private _themeService: ThemeService) {}
    ...
    ngOnInit(): void {
        ...
        this.selected = this.updateThemeForm() != null ? this.updateThemeForm() : 'codeit-theme';
