...
export const mockError: ErrorResponse = {
    ...
    title: 'Erro de teste',
    errors: {
        ValidationsErrors: ['Deve ser informada uma renda mensal válida, maior que 0 (zero).']
    }
};
...
export const mockError1: ErrorResponse = {
    ...
    errors: {
        ValidationsErrors: ['Campo obrigatório']
    }
};
...
export const mockError2: ErrorResponse = {
    ...
    errors: {
        ValidationsErrors: ['Valor minimo 4']
    }
};
...
export const mockError3: ErrorResponse = {
    ...
    title: 'Erro de teste 2',
    errors: {
        ValidationsErrors: ['Valor minimo 4', 'Campo obrigatório', 'Deve ser informada uma renda mensal válida, maior que 0 (zero).']
    }
};
